...
自动选择会对部分容易误判的主题做额外校准：

- 第一层优先识别明确场景词：火车、海边、星空宇宙、农村亲情、城市通勤、山路远方等。
- 第二层再识别抽象创作意图：现实执行、习惯沉淀、认知到行动、向外挑战、孤独开阔等。
- “习惯、沉淀、行动、执行、待办、遗留、电脑、笔记”等现实执行主题，会优先靠近 `现实工作台`。
- “火车旅途”需要更明确的火车、列车、车窗、站台、车票、铁轨、旅途、远行等线索；仅有“经历、起点、选择”这类泛旅程词时会被降权。
